...
background-image: url(https://images.alwatanvoice.com/news/large/9998451553.jpg)
...
# The unpredictable weather in Melbourne

.footnote[Image credit: [alwatanvoice](https://www.alwatanvoice.com/arabic/content/print/515691.html)]
...
```
--
- The location.csv data is the clean data which was originally downloaded from [City of Melbourne- Microclimate-Sensor-locations](https://data.melbourne.vic.gov.au/Environment/Microclimate-Sensor-Locations/irqv-hjr4) which contains the location and location description for each microclimate sensor device installed throughout the city.
--

### The locations of the sensor in Map

```{r sensor-location, out.height='50%', out.width='100%'}
...
.pull-right[
- The data types includes:  **Numeric**, **Character**, **Date**.

- The end_reading variable in this data set are all missing

- The fourth data is found missing in last_data.
